...
class ECDDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        dat_filename = img_filename.replace('.jpg', 'hor.mat')
...
def build_ecd(image_set, cfg):
    
    root = '/data/project/rw/ecd_gt/'

    img_folder = root
    dataset = ECDDataset(cfg, img_folder, return_masks=cfg.MODELS.MASKS, transform=make_transform())
    return dataset